...
define('aurelia-templating/view-engine',['exports', 'core-js', 'aurelia-logging', 'aurelia-loader', 'aurelia-dependency-injection', './view-compiler', './resource-registry', 'aurelia-binding', './view-strategy', './util', 'aurelia-metadata', 'aurelia-task-queue', './content-selector', './bindable-property', './behavior-instance'], function (exports, _coreJs, _aureliaLogging, _aureliaLoader, _aureliaDependencyInjection, _viewCompiler, _resourceRegistry, _aureliaBinding, _viewStrategy, _util, _aureliaMetadata, _aureliaTaskQueue, _contentSelector, _bindableProperty, _behaviorInstance) {
  ...
  var ViewEngine = (function () {
    ...
    _createClass(ViewEngine, [{
      ...
      key: 'inject',
      value: function inject() {
        return [_aureliaLoader.Loader, _aureliaDependencyInjection.Container, _viewCompiler.ViewCompiler, ModuleAnalyzer, _resourceRegistry.ResourceRegistry];
      }
    }]);
      ...
      value: function load(container, target, viewStrategy, transientView) {
        ...
        if (this.elementName !== null) {
          ...
          return viewStrategy.loadViewFactory(container.get(ViewEngine), options).then(function (viewFactory) {
            if (!transientView) {
              _this4.viewFactory = viewFactory;
            }
...
define('aurelia-templating/composition-engine',['exports', 'aurelia-metadata', './view-strategy', './view-engine'], function (exports, _aureliaMetadata, _viewStrategy, _viewEngine) {
      ...
      value: function createBehavior(instruction) {
        ...
        return this.activate(instruction).then(function () {
          ...
          if (viewModelResource) {
            ...
            metadata = new _viewEngine.HtmlBehaviorResource();
...
define('aurelia-templating/decorators',['exports', 'core-js', 'aurelia-metadata', './bindable-property', './children', './element-config', './view-strategy', './view-engine'], function (exports, _coreJs, _aureliaMetadata, _bindableProperty, _children, _elementConfig, _viewStrategy, _viewEngine) {
  ...
  function behavior(override) {
    return function (target) {
      ...
      if (override instanceof _viewEngine.HtmlBehaviorResource) {
        meta.add(override);
      } else {
        var resource = meta.firstOrAdd(_viewEngine.HtmlBehaviorResource);
  ...
  function customElement(name) {
    return function (target) {
      var resource = _aureliaMetadata.Metadata.on(target).firstOrAdd(_viewEngine.HtmlBehaviorResource);
...
define('aurelia-templating/index',['exports', './view-engine', './bindable-property', './resource-registry', './children', './element-config', './view-strategy', './view-compiler', './view-factory', './view-slot', './binding-language', './composition-engine', './animator', './decorators'], function (exports, _viewEngine, _bindableProperty, _resourceRegistry, _children, _elementConfig, _viewStrategy, _viewCompiler, _viewFactory, _viewSlot, _bindingLanguage, _compositionEngine, _animator, _decorators) {
  ...
  Object.defineProperty(exports, 'HtmlBehaviorResource', {
    enumerable: true,
    get: function get() {
      return _viewEngine.HtmlBehaviorResource;
    }
  });
