...
cp typings/aurelia/* ../aurelia-typescript/skel-nav-require-vs-ts/skel-nav-require-vs-ts/typings/aurelia

# skel-nav-esri-gulp
cp scripts/aurelia/* ../aurelia-typescript/skel-nav-esri-gulp/scripts/aurelia
cp typings/aurelia/* ../aurelia-typescript/skel-nav-esri-gulp/typings/aurelia

# pwkad-aurelia-samples
cp scripts/aurelia/* ../aurelia-typescript/pwkad-aurelia-samples/pwkad-aurelia-samples/scripts/aurelia
cp typings/aurelia/* ../aurelia-typescript/pwkad-aurelia-samples/pwkad-aurelia-samples/typings/aurelia

# code-sandbox
cp scripts/aurelia/* ../aurelia-typescript/code-sandbox/code-sandbox/scripts/aurelia
cp typings/aurelia/* ../aurelia-typescript/code-sandbox/code-sandbox/typings/aurelia


# multi-level-menu
cp scripts/aurelia/* ../aurelia-typescript/multi-level-menu/multi-level-menu/scripts/aurelia
cp typings/aurelia/* ../aurelia-typescript/multi-level-menu/multi-level-menu/typings/aurelia

# todo-require-vs-ts
cp scripts/aurelia/* ../aurelia-typescript/todo-require-vs-ts/todo-require-vs-ts/scripts/aurelia
cp typings/aurelia/* ../aurelia-typescript/todo-require-vs-ts/todo-require-vs-ts/typings/aurelia

# aurelia-vs-ts (@Lakerfield)
cp scripts/aurelia/* ../aurelia-typescript/aurelia-vs-ts/aurelia-vs-ts/scripts/aurelia
cp typings/aurelia/* ../aurelia-typescript/aurelia-vs-ts/aurelia-vs-ts/typings/aurelia

# aurelia-vs-ts-tests
cp scripts/aurelia/* ../aurelia-typescript/aurelia-vs-ts-tests/aurelia-vs-ts-tests/scripts/aurelia
